...
def get_p10_report_data(filters):
    ...
    query = (
        ...
        .select(
            ...
            salary_component_doc.custom_p10a_tax_deduction_card_type.as_("salary_component"),
            Case()
        ...
        .where(
            salary_component_doc.custom_p10a_tax_deduction_card_type.isin(salary_components)
    ...
    for employee_key, components in employee_data.items():
        ...
        row = {"custom_pin": employee_pin, "employee_name": employee_name}
